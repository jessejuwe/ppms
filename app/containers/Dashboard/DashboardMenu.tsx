...
const DashboardMenu: React.FC = () => {
  ...
  return (
    <Accordion allowToggle>
      <AccordionItem>
        <h2>
          <AccordionButton _expanded={{ bg: 'secondary.700', color: 'white' }}>
        ...
        <AccordionPanel pb={4}>
          <VStack spacing={4} align="start" justify="center">
            <Text>
              One of the primary aims of HYPPADEC Empowerment initiatives is to
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          <VStack spacing={4} align="start" justify="center">
            <Text>
              The HYPPADEC Community Support Programme (CSP) strives to improve
